...
const features = [
  {
    icon: <LuCaravan className="text-4xl lg:text-5xl text-green-500 shrink-0" />,
    title: "Free Shipping",
    description: "Free shipping on all your orders",
  },
  {
    icon: <BiSupport className="text-4xl lg:text-5xl text-green-500 shrink-0" />,
    title: "Customer Support 24/7",
    description: "Instant access to support",
  },
  {
    icon: <BsBagCheckFill className="text-4xl lg:text-5xl text-green-500 shrink-0" />,
    title: "100% Secure Payment",
    description: "We ensure your money is safe",
  },
  {
    icon: <FaBoxOpen className="text-4xl lg:text-5xl text-green-500 shrink-0" />,
